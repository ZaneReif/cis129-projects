#CIS129_ZaneReif_Lab4.py

#Module 4 Lab-4
#Zane Reif
#2/25/24
#This program can be used to determine store and employee bonus amounts based on sales
...
monthlySales = (float(input(prompt))) #monthly sales amount
